o<template>
    <div id="contact">
        <a href="#about_me" class="title animated bounceIn">
            <p id="about_me" class="headline">
                About me
            </p>
        </a>
        <div class="info animated tada">
            <img :src="`/profile/${new Date().getDate() % 3}.jpg`" alt="me">
            <div class="wraper">
                <p class="left">
                    邮箱:
                </p>
                ...
                <p class="left">
                    外站链接:
                </p><a class="right" href="https://www.imooc.com/u/2716205/articles">
                  www.imooc.com/u/2716205/articles
                </a>
            </div>
        </div>
    </div>
